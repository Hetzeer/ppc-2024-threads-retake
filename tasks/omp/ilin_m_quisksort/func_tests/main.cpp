...
TEST(ilin_m_quicksort_omp, Sort_Vec_10) {
  ...
  // Create data
  std::vector<int> in = ilin_m_quicksort_omp::getRandomVec(count);
  ...
  ASSERT_TRUE(ilin_m_quicksort_omp::checkOrder(seq_out));
  ASSERT_TRUE(ilin_m_quicksort_omp::checkOrder(par_out));
}

TEST(ilin_m_quicksort_omp, Sort_Vec_100) {
  const int count = 100;
...
TEST(ilin_m_quicksort_omp, Sort_Vec_1000) {
...
TEST(ilin_m_quicksort_omp, Sort_Vec_10000) {
...
TEST(ilin_m_quicksort_omp, Sort_Vec_50000) {
