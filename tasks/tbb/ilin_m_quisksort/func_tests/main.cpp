...
TEST(ilin_m_quicksort_tbb, Sort_Vec_10) {
  const int count = 10;

  // Create data
  std::vector<int> in = ilin_m_quicksort_tbb::getRandomVec(count);
  ...
  // Create Task
  ilin_m_quicksort_tbb::QuisksortTBBTaskSequential testTaskSequential(taskDataSeq);
  ...
  // Create Task
  ilin_m_quicksort_tbb::QuisksortTBBTaskParallel testTaskParallel(taskDataPar);
...
TEST(ilin_m_quicksort_tbb, Sort_Vec_100) {
  const int count = 100;
...
TEST(ilin_m_quicksort_tbb, Sort_Vec_1000) {
...
TEST(ilin_m_quicksort_tbb, Sort_Vec_10000) {
...
TEST(ilin_m_quicksort_tbb, Sort_Vec_50000) {
