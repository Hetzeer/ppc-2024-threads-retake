...
TEST(ilin_m_quicksort_stl, Sort_Vec_10) {
  ...
  // Create Task
  ilin_m_quicksort_stl::QuicksortSTLTaskSequential testTaskSequential(taskDataSeq);
  ...
  // Create Task
  ilin_m_quicksort_stl::QuicksortSTLTaskParallel testTaskParallel(taskDataPar);
